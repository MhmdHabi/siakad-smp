...
@section('judul', 'Edit Jadwal Pelajaran')
...
@section('content')
    <div class="container mx-auto mt-5">
        ...
        <h1 class="text-lg lg:text-2xl font-semibold text-gray-800 mb-4">Edit Jadwal Pelajaran</h1>

        <form action="{{ route('jadwal_pelajaran.update', $jadwal->id) }}" method="POST"
            ...
            <div class="mb-4">
                ...
                <select name="ruangan_id" id="ruangan_id"
                    ...
                    @foreach ($ruangan as $r)
                        <option value="{{ $r->id }}"
                            {{ old('ruangan_id', $jadwal->ruangan_id) == $r->id ? 'selected' : '' }}>
                            {{ $r->nama_ruangan }}
                        </option>
                    @endforeach
                </select>
